...
var ArrayUtil = /** @class */ (function () {
    ...
    ArrayUtil.uniq = function (arr) { return Array.from(new Set(__spreadArrays(arr))); };
    // Removes null, empty, undefined, falsy values from list
    ArrayUtil.compact = function (arr) { return arr.filter(Boolean); };
    ArrayUtil.reverse = function (arr) { return arr.reverse(); };
    ArrayUtil.union = function (arr1, arr2) { return __spreadArrays(new Set(__spreadArrays(arr1, arr2))); };
    ArrayUtil.intersection = function (arr1, arr2) { return Array.from(new Set(__spreadArrays(arr1).filter(function (x) { return arr2.indexOf(x) >= 0; }))); };
    ...
    ArrayUtil.flattenByDepth = function (arr, depth) {
        ...
        return arr.reduce(function (a, v) { return a.concat(depth > 1 && Array.isArray(v) ? ArrayUtil.flattenByDepth(v, depth - 1) : v); }, []);
    };
    ArrayUtil.last = function (arr) { return arr[arr.length - 1]; };
     ...
     * @param size
     */
    ArrayUtil.chunk = function (arr, size) { return Array.from({ length: Math.ceil(arr.length / size) }, function (v, i) {
